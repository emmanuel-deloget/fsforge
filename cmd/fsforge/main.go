...
usage:
  fsforge mkfs -type <ext2|ext4|fat|exfat|iso|squashfs|erofs|cpio> -source <dir> -output <file> [options]
...
convert: <kind> is dir, ext2, ext4, squashfs, exfat, iso, erofs, cpio or oci.
  -from <kind>:<path>   source  (dir, ext2, ext4, squashfs, exfat, iso, erofs, cpio, oci)
  -to   <kind>:<path>   sink    (dir, ext2, ext4, squashfs, exfat, iso, erofs, cpio, oci)
