...
usage:
  fsforge mkfs -type <ext2|ext4|fat|exfat|iso|squashfs|erofs> -source <dir> -output <file> [options]
...
convert: <kind> is dir, ext2, ext4, squashfs, exfat, iso, erofs or oci.
  -from <kind>:<path>   source  (dir, ext2, ext4, squashfs, exfat, iso, erofs, oci)
  -to   <kind>:<path>   sink    (dir, ext2, ext4, squashfs, exfat, iso, erofs, oci)
